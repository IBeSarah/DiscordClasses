...
// Compare modules and generate diff text
...
// Post to Discord webhook (first 2000 chars)
(async () => {
  ...
  const maxLength = MAX_DISCORD - footer.length;
  const truncated = fullDiff.length > maxLength ? fullDiff.slice(0, maxLength) + '\n... (truncated)' : fullDiff;
